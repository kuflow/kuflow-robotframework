...
# body param
SchemaForRequestBodyApplicationJson = AssignTaskCommand


request_body_assign_task_command = api_client.RequestBody(
    content={
...
class ActionsAssignTask(api_client.Api):
    def actions_assign_task(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_assign_task_command.serialize(body, content_type)
