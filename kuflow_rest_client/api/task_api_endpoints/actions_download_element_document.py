...
request_query_document_id = api_client.QueryParameter(
    name="documentId",
...
_path = "/tasks/{id}/~actions/download-element-document"
_method = "GET"
_auth = [
    "BasicAuth",
]
SchemaFor200ResponseBody = BinarySchema
...
class ActionsDownloadElementDocument(api_client.Api):
    def actions_download_element_document(
        self: api_client.Api,
        ...
        _query_params = []
        for parameter in (request_query_document_id,):
