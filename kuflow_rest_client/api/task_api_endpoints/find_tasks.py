...
class ProcessIdSchema(ListSchema):
    _items = StrSchema


class StateSchema(ListSchema):
    @classmethod
    @property
    def _items(cls) -> typing.Type["TaskState"]:
        return TaskState
...
SchemaFor200ResponseBodyApplicationJson = TaskPage
...
class FindTasks(api_client.Api):
    def find_tasks(
        self: api_client.Api,
