...
class AuthenticationAllOf(DictSchema):
    ...
    @classmethod
    @property
    def type(cls) -> typing.Type["AuthenticationType"]:
    ...
    def __new__(
        ...
        *args: typing.Union[
        ...
        type: typing.Union["AuthenticationType", Unset] = unset,
        token: typing.Union[token, Unset] = unset,
        expiredAt: typing.Union[expiredAt, Unset] = unset,
