...
class ElementDefinitionType(
    ...
    @property
    def FORM(cls):
        return cls._enum_by_value["FORM"]("FORM")

    @classmethod
    @property
    def DOCUMENT(cls):
        return cls._enum_by_value["DOCUMENT"]("DOCUMENT")

    @classmethod
    @property
    def DECISION(cls):
        return cls._enum_by_value["DECISION"]("DECISION")

    @classmethod
    @property
    def FIELD(cls):
        return cls._enum_by_value["FIELD"]("FIELD")
