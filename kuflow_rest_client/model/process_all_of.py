...
class ProcessAllOf(DictSchema):
    ...
    _required_property_names = set(("processDefinition",))
    id = StrSchema
    ...
    @classmethod
    @property
    def processDefinition(cls) -> typing.Type["ProcessDefinitionSummary"]:
    ...
    class initiator(ComposedSchema):
        @classmethod
        @property
        def _composed_schemas(cls):
            # we need this here to make our import statements work
    ...
    def __new__(
        ...
        *args: typing.Union[
        ...
        initiator: typing.Union[initiator, Unset] = unset,
        _instantiation_metadata: typing.Optional[InstantiationMetadata] = None,
        **kwargs: typing.Type[Schema],
    ) -> "ProcessAllOf":
        return super().__new__(
