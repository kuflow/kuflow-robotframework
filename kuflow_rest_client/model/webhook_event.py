...
class WebhookEvent(DictSchema):
    ...
    @classmethod
    @property
    def type(cls) -> typing.Type["WebhookType"]:
        return WebhookType
    ...
    def _discriminator(cls):
        return {
            "type": {
                ...
                "WebhookEventProcessStateChanged": WebhookEventProcessStateChanged,
                "WebhookEventTaskStateChanged": WebhookEventTaskStateChanged,
            }
        }
