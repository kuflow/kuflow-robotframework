...
class WebhookEventProcessStateChangedAllOf(DictSchema):
    ...
    _required_property_names = set(("data",))

    @classmethod
    @property
    def data(cls) -> typing.Type["WebhookEventProcessStateChangedData"]:
        return WebhookEventProcessStateChangedData
