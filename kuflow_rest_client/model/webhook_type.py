...
class WebhookType(
    _SchemaEnumMaker(
        enum_value_to_name={
            "PROCESS.STATE_CHANGED": "PROCESS__STATE_CHANGED",
            "TASK.STATE_CHANGED": "TASK__STATE_CHANGED",
        }
    ),
    StrSchema,
):
    ...
    @classmethod
    @property
    def PROCESS__STATE_CHANGED(cls):
        return cls._enum_by_value["PROCESS.STATE_CHANGED"]("PROCESS.STATE_CHANGED")

    @classmethod
    @property
    def TASK__STATE_CHANGED(cls):
        return cls._enum_by_value["TASK.STATE_CHANGED"]("TASK.STATE_CHANGED")
